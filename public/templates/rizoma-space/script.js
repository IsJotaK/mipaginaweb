...
quoteForm.addEventListener('submit', (e) => {
  ...
  const serviceLabels = { 'arriendo-contenedor': 'Arriendo de Contenedor', 'retiro-escombros': 'Retiro de Escombros', 'otro': 'Otro' };
  const volumeLabels = { 'pequeno': 'Pequeño (menos de 3m³)', 'mediano': 'Mediano (3m³ - 7m³)', 'grande': 'Grande (más de 7m³)', 'no-seguro': 'No estoy seguro' };

  let whatsappMsg = `Hola ContainerPro, quiero cotizar:%0A%0A`;
